...
const Navbar = () => {
    ...
    {/* // <nav className="navbar navbar-expand-lg navbar-light bg-dark"> */}
      ...
      {/* <div className="collapse navbar-collapse" id="collapsingNavbar2"> */}
          ...
          <button className="navbar-toggler md-auto" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <FontAwesomeIcon icon={faBars} style={{ color: "#fff" }} />
    </button>
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
              ...
              <li className="nav-item">
                  <Link smooth={false}  to="about" offset={-50} className="nav-link" href="#">About Me</Link> 
              </li>
            
              <li className="nav-item">
                  <Link smooth={false}  to="projects" offset={-10} className="nav-link" href="#">Projects</Link> 
              </li>
                <li className="nav-item">
              ...
              <li className="nav-item">
                  <Link smooth={false}  to="contactme" offset={-50} className="nav-link" href="#">Contact</Link> 
              </li>
              {/* <li className="nav-item">
